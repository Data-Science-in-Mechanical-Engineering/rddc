...
def get_settings():
    ...
    extra_loads_synth = [
        # {'mass': 0.000 ,'position':np.array([ 0.00,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        # {'mass': 0.000 ,'position':np.array([ 0.00,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        # {'mass': 0.000 ,'position':np.array([ 0.00,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        # {'mass': 0.000 ,'position':np.array([ 0.00,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        # {'mass': 0.000 ,'position':np.array([ 0.00,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        ...
        # {'mass': 0.000 ,'position':np.array([ 0.00,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        # {'mass': 0.000 ,'position':np.array([ 0.00,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        {'mass': 0.010 ,'position':np.array([ 0.01,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        {'mass': 0.010 ,'position':np.array([ 0.01,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        {'mass': 0.010 ,'position':np.array([ 0.01,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        {'mass': 0.010 ,'position':np.array([ 0.01,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
        {'mass': 0.010 ,'position':np.array([ 0.01,  0.0, 0.0]), 'form':'ball', 'size':[0.0]},
    ...
    mass_range = [0.0015, 0.030]
    pos_size = [0.02, 0.02, 0.002]
    ...
    # performance metric
    Q = np.eye(n, n)*np.diag([10,10,0.01,0.01,1,1])
    S = np.zeros((n, m))
    R = np.eye(m, m)*0.01
