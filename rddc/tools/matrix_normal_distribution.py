...
class MN(object):
    ...
    def sample_vec(self, rnd, n=1):

        return multivariate_normal.rvs(self.m.reshape(-1), self.E, size=n, random_state=rnd)
    ...
    def sample_truncated(self, n, c, rnd):
        ...
        while len(accepted_samples) < n:
            ...
            samples = self.sample_vec(rnd, min(max(10, expected_draws), int(1e6)))
